...
// Created: 10/28/2011 5:40:31 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs60s2es00000kbemuolm2uf_1n3j";
	this.domain="sdc8prod1.wiley.com";
	this.timezone=-5;
	this.fpcdom="";
	this.onsitedoms="http://media.wiley.com";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx,mp3";
